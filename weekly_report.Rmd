...
districts_overview <- addmargins(table(State = districts$State, districts$Remarks))
districts_overview2 <- addmargins(table(State = districts$State, districts$Spread))
districts_overview3 <- addmargins(table(State = districts$Remarks, districts$Spread))
