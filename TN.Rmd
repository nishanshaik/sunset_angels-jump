...
gadm$NAME_2[gadm$NAME_2 == "The Nilgiris"] <- "Nilgiris"             # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Virudunagar"] <- "Virudhunagar"          # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Nagappattinam"] <- "Nagapattinam"        # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Kanniyakumari"] <- "Kanyakumari"         # Standardising names
