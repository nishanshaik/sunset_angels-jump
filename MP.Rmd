...
gadm$NAME_2[gadm$NAME_2 == "East Nimar"] <- "Khandwa"                # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Narsimhapur"] <- "Narsinghpur"           # Standardising names
gadm$NAME_2[gadm$NAME_2 == "West Nimar"] <- "Khargone"               # Standardising names
