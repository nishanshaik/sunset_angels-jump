...
gadm$NAME_2[gadm$NAME_2 == "Ahmadnagar"] <- "Ahmednagar"                # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Bid"] <- "Beed"         # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Buldana"] <- "Buldhana"   # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Garhchiroli"] <- "Gadchiroli"                  # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Gondiya"] <- "Gondia"                   # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Mumbai City"] <- "Mumbai"                # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Mumbai Suburban"] <- "Mumbai"      # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Raigarh"] <- "Raigad"     # Standardising names
