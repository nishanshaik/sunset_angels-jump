...
Daily R plots provide the users with a near-runtime situation analysis while also showing how a region has progressed in the past. These estimates use 14-day simple moving average for smoothing. It provides the user with a daily-updated, most recent estimates of effective R for each region.

\

## Will there be further updates?
This website is auto-updated daily. If you see any issues in the updates, kindly drop me an email. 