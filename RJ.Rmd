...
gadm$NAME_2[gadm$NAME_2 == "Jalor"] <- "Jalore"                      # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Jhunjhunun"] <- "Jhunjhunu"              # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Dhaulpur"] <- "Dholpur"                  # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Chittaurgarh"] <- "Chittorgarh"          # Standardising names
