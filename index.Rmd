...
An effective R above 1 does point to higher risk, but to righly assess the risk, you need more than just the R-values. A better indicator for household level decision making are the test positivity rates. 
