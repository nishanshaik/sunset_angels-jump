...
gadm$NAME_2[gadm$NAME_2 == "Firozpur"] <- "Ferozepur"                      # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Sahibzada Ajit Singh Nagar"] <- "S.A.S. Nagar"           # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Muktsar"] <- "Sri Muktsar Sahib"               # Standardising names
