...
gadm$NAME_2[gadm$NAME_2 == "Pashchim Champaran"] <- "West Champaran" # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Purba Champaran"] <- "East Champaran"   # Standardising names
