...
gadm$NAME_2[gadm$NAME_2 == "Bemetara"] <- "Bametara" # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Dantewada"] <- "Dakshin Bastar Dantewada"   # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Janjgir-Champa"] <- "Janjgir Champa"   # Standardising names
