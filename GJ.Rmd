...
gadm$NAME_2[gadm$NAME_2 == "Ahmadabad"] <- "Ahmedabad"    # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Banas Kantha"] <- "Banaskantha"    # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Kachchh"] <- "Kutch"    # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Mahesana"] <- "Mehsana"    # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Panch Mahals"] <- "Panchmahal"    # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Sabar Kantha"] <- "Sabarkantha"    # Standardising names
gadm$NAME_2[gadm$NAME_2 == "The Dangs"] <- "Dang"    # Standardising names
