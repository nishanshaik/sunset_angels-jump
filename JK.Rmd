...
# gadm$NAME_2[gadm$NAME_2 == "Kodarma"] <- "Koderma"    # Standardising names
# gadm$NAME_2[gadm$NAME_2 == "Pashchimi Singhbhum"] <- "West Singhbhum"    # Standardising names
# gadm$NAME_2[gadm$NAME_2 == "Purbi Singhbhum"] <- "East Singhbhum"    # Standardising names
# gadm$NAME_2[gadm$NAME_2 == "Saraikela-kharsawan"] <- "Saraikela-Kharsawan"    # Standardising names
...
```{r Map, include = FALSE, echo = FALSE, fig.width = 10, fig.height = 10, warning = FALSE}
