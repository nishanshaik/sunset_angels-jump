...
gadm$NAME_2[gadm$NAME_2 == "Nellore"] <- "S.P.S. Nellore" # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Y.S.R."] <- "Y.S.R. Kadapa"   # Standardising names
...
gadm$NAME_2 %in% districts$District
sum(unique(gadm$NAME_2) %in% unique(districts$District))
