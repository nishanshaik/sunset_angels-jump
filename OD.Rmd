...
gadm$NAME_2[gadm$NAME_2 == "Anugul"] <- "Angul"                      # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Baleshwar"] <- "Balasore"           # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Bauda"] <- "Boudh"               # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Debagarh"] <- "Deogarh"               # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Jagatsinghapur"] <- "Jagatsinghpur"               # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Jajapur"] <- "Jajpur"               # Standardising names
