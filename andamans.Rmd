...
Trends in effective R numbers smoothed using 7-day simple moving average for Andaman & Nicobar Islands.
...
p <- data %>% 
  ...
  labs(x = "",
       ...
       title = "Trends in effective R numbers for Andaman & Nicobar Islands") +
  theme_minimal() +
    theme(legend.position = "bottom")

ggplotly(p, dynamicTicks = TRUE) %>% 
  layout(legend = list(x = 0, y = -300, orientation = 'v'))
```
