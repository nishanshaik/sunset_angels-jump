...
gadm$NAME_2[gadm$NAME_2 == "Barddhaman"] <- "Purba Bardhaman"             # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Darjiling"] <- "Darjeeling"                  # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Haora"] <- "Howrah"             # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Hugli"] <- "Hooghly"                  # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Koch Bihar"] <- "Cooch Behar"            # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Maldah"] <- "Malda"            # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Puruliya"] <- "Purulia"            # Standardising names
gadm$NAME_2[gadm$NAME_2 == "Pashchim Medinipur"] <- "Paschim Medinipur"            # Standardising names
